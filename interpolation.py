...
Run 'python %(prog)s <subcommand> --help' for subcommand help.''',
    ...
    parser_interpolation_video = subparsers.add_parser('interpolation-video', help='Generate interpolation video')
	parser_interpolation_video.add_argument('--network', help='Network pickle filename', dest='network_pkl', required=True)
	parser_interpolation_video.add_argument('--video-length', type=float, help='Length of interpolation video', default=30.0)
	parser_interpolation_video.add_argument('--truncation-psi', type=float, help='Truncation psi (default: %(default)s)', default=0.5)
	parser_interpolation_video.add_argument('--result-dir', help='Root directory for run results (default: %(default)s)', default='results', metavar='DIR')
    ...
    func_name_map = {
		...
		'interpolation-video': 'run_generator.interpolation_video'
    }
